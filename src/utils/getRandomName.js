...
class RandomName {
  ...
  getFemaleName(sur) {
    ...
    if (r === 0) {
      return (this.getFamilyName(sur) + this.femaleNameItems[randomNum(0, this.femaleNameItems.length - 1)] + this.femaleNameItems[randomNum(0, this.femaleNameItems.length - 1)]);
    } else {
      return (this.getFamilyName(sur) + this.femaleNameItems[randomNum(0, this.femaleNameItems.length - 1)]);
    }
  }
  ...
  getMaleName(sur) {
    const r = randomNum(0, 1);
    if (r === 0) {
      return (this.getFamilyName(sur) + this.maleNameItems[randomNum(0, this.maleNameItems.length - 1)] + this.maleNameItems[randomNum(0, this.maleNameItems.length - 1)]);
    } else {
      return (this.getFamilyName(sur) + this.maleNameItems[randomNum(0, this.maleNameItems.length - 1)]);
    }
  }
  ...
  getName(sur) {
    const r = randomNum(0, 1);
    if (r === 0) {
      return (this.getFamilyName(sur) + this.allName[randomNum(0, this.allName.length - 1)] + this.allName[randomNum(0, this.allName.length - 1)]);
    } else {
